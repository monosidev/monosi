...
# from core.common.drivers.base import BaseDriverConfiguration, BaseSqlAlchemyDriver
...
#         return 'snowflake://{user}:{password}@{account_identifier}/'.format(
#             user=self.user,
...
#         results = self.execute(describe_table_sql)
