  ...
  return (
    <section className="my-20">
      ...
      <ul className="grid gap-6  sm:grid-cols-2 xl:gap-8">
        <li>
          ...
          >
            ...
            <div className="flex-auto">
              ...
              <p>Give Monosi a star on GitHub (it helps!)</p>
            </div>
          </a>
        </li>
        <li>
        ...
        <li>
          <a
            href="https://twitter.com/monosidev"
            className="flex items-start space-x-4"
          >
            <svg
              fill="currentColor"
            ...
            <div className="flex-auto">
              ...
              <p>
                Follow <span className="text-blue-400">@monosidev</span> for
                Monosi news and events.
              </p>
            </div>
          </a>
        </li>
        <li>
          ...
          >
            ...
            <div className="flex-auto">
              ...
              <p>Watch tutorials and meetups with Monosi users.</p>
            </div>
          </a>
        </li>
      </ul>
      <p className="mt-8">
        We are happy to help you with your job listings, talks, blogposts (whether on our blog or yours) or anything else you want to try. Just{" "}
        <a
          ...
          <ul className="mt-8 list-disc space-y-3 pl-4">
            <li className="list-disc">
              <p className="">
                ...
                >
                  Check in with and contribute to the community{" "}
                  <svg
